...
using DocumentProcessing.Documents.Word.OpenXml.Utilities;
...
/// <summary>
/// Обработчик фигур (Shapes) документа Microsoft Word в формате OpenXML.
/// Выполняет поиск и замену текста внутри VML и DrawingML фигур, включая Inline и Anchor элементы.
/// </summary>
public class WordOpenXmlShapesHandler : BaseDocumentElementHandler<WordOpenXmlDocumentContext>
{
    ...
    /// <summary>
    /// Инициализирует новый экземпляр обработчика фигур Word OpenXML.
    /// </summary>
    ...
    /// <summary>
    /// Выполняет обработку всех фигур документа.
    /// Обрабатывает VML Shapes, Inline и Anchor DrawingML элементы.
    /// </summary>
    ...
    /// <returns>Результат обработки в виде <see cref="ProcessingResult"/>, включая количество найденных и обработанных совпадений и возможные предупреждения.</returns>
    ...
    /// <summary>
    /// Обрабатывает текст внутри VML фигуры, выполняя поиск и замену.
    /// </summary>
    /// <param name="shape">VML фигура для обработки.</param>
    ...
    /// <summary>
    /// Обрабатывает текст внутри DrawingML элемента (Inline или Anchor).
    /// </summary>
    /// <param name="element">DrawingML элемент.</param>
    /// <param name="config">Конфигурация обработки.</param>
    /// <returns>Результат обработки в виде <see cref="ProcessingResult"/>.</returns>
    ...
    /// <summary>
    /// Создаёт карту текста DrawingML элементов для упрощения замены текста.
    /// </summary>
    /// <param name="textElements">Список элементов текста DrawingML.</param>
    /// <returns>Список объектов <see cref="DrawingTextInfo"/>, содержащих позиции и содержимое текста.</returns>
    ...
    /// <summary>
    /// Выполняет замену текста в диапазоне DrawingML элементов.
    /// </summary>
    /// <param name="map">Карта текста DrawingML элементов.</param>
    /// <param name="startIndex">Начальная позиция замены.</param>
    /// <param name="length">Длина заменяемого текста.</param>
    /// <param name="replacement">Новый текст для вставки.</param>
    /// <returns><c>true</c>, если замена успешна; иначе <c>false</c>.</returns>
    ...
    /// <summary>
    /// Вспомогательный класс для хранения информации о тексте DrawingML элементов.
    /// </summary>
